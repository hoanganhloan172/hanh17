...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvmyprofilelogo = (TextView) view.findViewById(R.id.tv_my_profile_logo_user);


        tvchangepassword = (TextView) view.findViewById(R.id.tv_change_password_frag_user);
        btnlogout = (Button) view.findViewById(R.id.logout_user);
